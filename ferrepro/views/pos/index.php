...
foreach ($products as $p) {
    ...
    $content .= '<div class="col-md-3 col-6 mb-2 product-card" data-category="' . ($p['category_id'] ?? '') . '" data-min-stock="' . $p['min_stock'] . '">
        <div class="card h-100 product-item ' . $stock_warning . '" style="cursor: pointer;" data-id="' . $p['id'] . '" data-name="' . htmlspecialchars($p['name']) . '" data-price="' . $p['sale_price'] . '" data-stock="' . $p['stock'] . '" data-min-stock="' . $p['min_stock'] . '" data-code="' . htmlspecialchars($p['code']) . '" data-iva="' . $p['iva'] . '">
        ...
        <div class="card">
            ...
            <div class="card-footer">
                ...
                <div class="mb-2">
                    ...
                    <select name="sale_type" id="saleType" class="form-select form-select-sm">
